...
const cardVariants = cva(
  'flex flex-col rounded-xl',
  {
    variants: {
      variant: {
        default: 'bg-card text-card-foreground gap-6 border py-6 shadow-sm',
        fancy:
...
interface CardProps extends Omit<React.ComponentProps<'div'>, 'title'>, VariantProps<typeof cardVariants> {
    ...
    return (
      ...
      >
        ...
        <div className="w-full h-full shadow-xl shadow-neutral-900 p-3 bg-neutral-600 opacity-50 rounded-xl flex-col gap-2 flex justify-center">
          {title && <span className="text-neutral-50 font-bold text-xl italic">{title}</span>}
